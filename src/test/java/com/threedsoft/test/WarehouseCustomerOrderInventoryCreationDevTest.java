...
public class WarehouseCustomerOrderInventoryCreationDevTest {
	...
	EventReceiver orderEventReceiver = new EventReceiver("whse-order-consumer", wmsStreams.ORDERS_OUTPUT,kafkaHost);
	EventReceiver pickEventReceiver = new EventReceiver("whse-pick-consumer", wmsStreams.PICK_OUTPUT,kafkaHost);
	EventReceiver packEventReceiver = new EventReceiver("whse-pack-consumer", wmsStreams.PACK_OUTPUT,kafkaHost);
	EventReceiver shipEventReceiver = new EventReceiver("whse-ship-consumer", wmsStreams.SHIP_OUTPUT,kafkaHost);
